...
# Import enhanced bedding zone predictor
...
class PredictionService:
    ...
    def __init__(self):
        ...
        # Initialize enhanced bedding zone predictor
        try:
            self.enhanced_bedding_predictor = EnhancedBeddingZonePredictor()
            self.logger.info("🛏️ Enhanced bedding zone predictor initialized successfully")
        except Exception as e:
            self.logger.warning(f"🛏️ Enhanced bedding zone predictor failed to initialize: {e}")
            self.enhanced_bedding_predictor = None
