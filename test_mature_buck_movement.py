...
def sample_terrain_features():
    return {
        ...
        'ridge_connectivity': 0.6,
        'nearest_road_distance': 800.0,
        'trail_density': 0.5,
        'hunter_accessibility': 0.4,
        'escape_cover_density': 70.0,
        'understory_density': 65.0,
        'visibility_limitation': 0.7,
        'agricultural_proximity': 300.0,
        'water_proximity': 250.0,
        'cover_type_diversity': 3.5,
        'edge_density': 0.6
    }
