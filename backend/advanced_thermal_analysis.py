...
class ThermalWindData:
    ...
    temperature_gradient: float # °F per 100ft elevation
...
# Global instance  
_thermal_analyzer = None

def get_thermal_analyzer() -> AdvancedThermalAnalyzer:
    """Get the global thermal analyzer instance"""
    global _thermal_analyzer
    if _thermal_analyzer is None:
        _thermal_analyzer = AdvancedThermalAnalyzer()
    return _thermal_analyzer
